...
## (https://docs.gitlab.com/omnibus/settings/redis.html#using-a-non-packaged-redis-instance)
redis['enable'] = false
...
# As per https://gitlab.com/gitlab-org/gitlab-ce/issues/15574 and https://docs.gitlab.com/omnibus/settings/nginx.html#supporting-proxied-ssl :
